...
int main()
{
    ...
    SCENE::Instance = main_scene;

    SCENE::Instance->backgroundColor = 0xAA;
    ENGINE_2D engine = ENGINE_2D(renderer, SCENE::Instance);
    //RECTANGLE* rect = new RECTANGLE(renderer);
    //SCENE::Instance->addChildNode(rect);
    //rect->height = 10;
    //rect->width = 10;
    //rect->pos_x = 50;
    //rect->pos_y = 50;
    ...
    //SCENE::Instance->addChildNode(rect2);
    //rect2->height = 50;
    //rect2->width = 10;
    //rect2->pos_x = 30;
    //rect2->pos_y = 30;
    ...
    //SCENE::Instance->addChildNode(rect3);
    //rect3->height = 20;
    //rect3->width = 20;
    //rect3->pos_x = 30;
    //rect3->pos_y = 30;
    ...
    //SCENE::Instance->addChildNode(text);
